...
description: 基于华为式经营与流程方法的总入口技能，用于在老板意图解码、战略规划、市场管理、产品规划、IPD 研发执行、销售 LTC、服务 ITR 和变革 PMO 等多个 skill 之间做路由、排序和衔接。适用于用户提出“该用哪套方法”“怎么解读老板战略和产品方向”“如何从战略落到产品和研发”“如何设计销售或服务闭环”“如何分阶段推进变革”这类需要先判断方法路径再执行的问题。
---
...
- `老板意图解码`：解读老板讲话、批注、会议纪要和方向反馈里的真实意图
...
- 只要涉及老板、CEO、创始人、业务负责人讲话或批注的战略意图、管理思想、产品方向解读，默认先用 `zh-leadership-intent-decoder`
